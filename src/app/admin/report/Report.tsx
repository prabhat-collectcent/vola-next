...
import { getReportsAction } from '@/actions/campaign.actions';
...
export default function ReportPage() {
    ...
    useEffect(() => {
        async function fetchReports() {
            ...
            setLoading(true);
            try {
                let queryParams: getReportsParams = { per_page: PAGE_SIZE, page_number: currentPage + 1 };
                ...
                const fetchedReports = await getReportsAction(queryParams);
                if (fetchedReports.success) {
                    ...
                    showToast(fetchedReports.message || 'Failed to fetch reports', 'error');
                }
