...
export default function Dashboard() {
  ...
  const stats = [
    { label: 'Impressions', value: '7,265', change: '+11.01%', trend: 'up' },
    { label: 'Clicks', value: '3,671', change: '-0.03%', trend: 'down' },
    { label: 'Conversions', value: '156', change: '+15.03%', trend: 'up' },
    { label: 'Spends', value: '2,318', change: '+6.08%', trend: 'up' },
  ];
